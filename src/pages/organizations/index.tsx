...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'meal_plan.count', 'pantry.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('meal_plan', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.meal_plan,
        }
      : null,
    hasAccess('pantry', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'pantry',
          header: 'Pantry',
          accessorKey: 'pantry',
          cell: ({ row: { original: record } }: any) => record?._count?.pantry,
        }
      : null,
